...
const remittanceRoutes = require('./remittance.routes');
...
const managerFieldDayRoutes = require('./managerFieldDay.routes');
...
router.use('/manager-field-days', managerFieldDayRoutes);
