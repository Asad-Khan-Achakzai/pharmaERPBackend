...
const create = asyncHandler(async (req, res) => {
  ApiResponse.created(res, await payrollService.create(req.companyId, req.body, req.user, tz(req)));
});
const update = asyncHandler(async (req, res) => {
  ApiResponse.success(res, await payrollService.update(req.companyId, req.params.id, req.body, req.user), 'Payroll updated');
});
