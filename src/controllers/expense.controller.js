...
const list = asyncHandler(async (req, res) => { ApiResponse.paginated(res, await expenseService.list(req.companyId, req.query, req.context.timeZone)); });
...
const approve = asyncHandler(async (req, res) => {
  ApiResponse.success(
    res,
    await expenseService.approve(req.companyId, req.params.id, req.body, req.user),
    'Expense approved'
  );
});
